...
-- ----------------------------
INSERT INTO `articulos` VALUES ('1', '1', '1', 'leche amarilla', 'leche gloria amarilla la de la abejita', '10');
INSERT INTO `articulos` VALUES ('2', '1', '1', '', 'gaseosa', '11');
INSERT INTO `articulos` VALUES ('3', '2', '1', 'grated de pescado', 'de marca atun', '7');
INSERT INTO `articulos` VALUES ('4', '1', '1', 'manjar', 'lll', '100');
INSERT INTO `articulos` VALUES ('5', '2', '1', 'manjar', 'de marca gloria', '100');
...
-- ----------------------------
INSERT INTO `detalle_salida` VALUES ('1', '2', '2', '1');
...
INSERT INTO `login` VALUES ('2', 'marce', '123', 'marcelinoaa', 'santos', 'santos@gmail.com');
...
-- Records of salida
-- ----------------------------
INSERT INTO `salida` VALUES ('1', '1', '2014-12-14', 'd', 'Boleta', '01-2', 'damner', 'mx-we', '1', null, null);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vista_articulos` AS select `articulos`.`id_articulo` AS `id_articulo`,`articulos`.`articulo` AS `articulo`,`articulos`.`descripcion` AS `descripcion`,`unidad_medida`.`unidad_medida` AS `unidad_medida`,`categoria`.`categoria` AS `categoria`,`articulos`.`stock` AS `stock` from ((`articulos` join `unidad_medida` on((`articulos`.`id_medida` = `unidad_medida`.`id_medida`))) join `categoria` on((`categoria`.`id_categoria` = `articulos`.`id_categoria`))) ;
